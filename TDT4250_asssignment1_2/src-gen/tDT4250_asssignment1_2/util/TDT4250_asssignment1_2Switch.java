 ...
 * @generated
 */
public class TDT4250_asssignment1_2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TDT4250_asssignment1_2Switch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TDT4250_asssignment1_2Package.SEMESTER_COURSE: {
			Semester_Course semester_Course = (Semester_Course) theEObject;
			T result = caseSemester_Course(semester_Course);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseSemester_Course(Semester_Course object) {
		return null;
	}
